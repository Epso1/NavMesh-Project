...
public class Enemy : MonoBehaviour
{
    ...
    [SerializeField] private float hearingRadius; // Radio de escucha
    ...
    [SerializeField] private float searchRadius = 4f; // Radio de busqueda
    [SerializeField] private float searchDuration = 5f; // Tiempo durante el cual el enemigo buscará al jugador
    ...
    void ChasePlayer(Vector2 lastPosition)
    {
        ...
        // Si ha llegado a la posición donde ha visto al jugador, cambia el estado a Patrol
